...
const ELIGIBLE = /україна|ukraine|весь світ|worldwide/i;
...
export function djinniEligible(location) {
  ...
  return ELIGIBLE.test(countries);
}
export function filterByLocation(jobs, excludeLocation) {
  ...
  return jobs.filter((j) => {
    if (j.source === "djinni") return djinniEligible(j.location);
