...
import { siteUrl, uniqueByUrl } from "./html.mjs";
...
// Absolute robota.ua vacancy URL without tracking params, or null if the href
// would leave the site (job.url is later page.goto()'d in the logged-in context).
export function jobUrl(href) {
  const url = siteUrl(href, "https://robota.ua");
