...
Hard rule: the candidate lives in Ukraine and works remotely from Ukraine. If the
vacancy is open only to residents of other countries or regions (e.g. "EU
residents only", "US-based", "Poland, Serbia"), requires relocation, or requires
office presence outside Ukraine, the fit is at most 10 regardless of skills, and
the first red flag must say so. A vacancy open to Ukraine, to Europe including
Ukraine, or worldwide is fine.
