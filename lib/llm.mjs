...
// From the first "{", try JSON.parse at each successive "}" — first success
// wins. Greedy /\{[\s\S]*\}/ broke on trailing prose containing a brace.
// ponytail: O(n · closing braces) worst case; a real reply has a handful of "}".
