...
function restoreFilters(){
  ...
  // removed one would show an empty board.
...
function syncThemeButton(){
  ...
  b.setAttribute('aria-pressed', dark ? 'true' : 'false');   // toggle button: constant name ("Dark theme", set in dashboard.mjs) + pressed state
}
