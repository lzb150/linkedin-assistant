...
export function formatNotification(summary) {
  ...
  // Nothing written → no banner. The hourly DOU run + 3-hourly full run made
  // ~30 "No new matches" banners a day, burying strong-match and health alerts;
  // the dashboard timestamp and the weekly report are the heartbeat now.
