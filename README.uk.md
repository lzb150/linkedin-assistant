...
- «Холодні» відгуки проходять попередній поріг за ключовими словами — `minScore` (типово 18) + `requireRole` — і далі поріг LLM (`llm.minScore`, 70), який і робить справжній відбір. `excludeLocation` лишає вакансію, де названа Україна, і віддалену вакансію DOU, де просто перелічено іноземний офіс; на Djinni список країн — це де мають жити кандидати, тож суто іноземний список відкидає вакансію навіть за «віддалено».
