...
**Нагадування про фолоу-ап (`followup.mjs`)** — опційно, типово не в розкладі
(інструмент — радар: він знаходить і готує, а відгукуєтесь ви вибірково, тож
функції пайплайну другорядні). Щоденне launchd-завдання
