...
- **LinkedIn Jobs** — скрейпінг пошуку (типово щогодини, вимикається; поверніть раз на день для меншого ризику виявлення)
...
- **HTML-дашборд** — усі вакансії на одній сторінці, відсортовані за
  релевантністю, з конвеєром статусів (New → Viewed → Applied), приватними
...
| Пошук на LinkedIn  | щогодини (о :45)      |
...
про всяк випадок при кожному скануванні. Оригінальний AppleScript-аплет
збережено у `Jobs.app.orig`.
...
**Конвеєр статусів** — кожна картка проходить три стадії:
**New → Viewed → Applied**. Позначка Applied записує дату і показує її як
"applied 5d ago". До будь-якої картки можна додати приватні нотатки — вони
зберігаються на диск через сервер стану. У шапці — живі лічильники статусів і
свіжості з фільтрацією за стадією.
...
**Applied** без руху 7+ днів. Поріг налаштовується змінною середовища
