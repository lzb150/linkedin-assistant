...
- **HTML-дашборд** — усі вакансії на одній сторінці, відсортовані за
  релевантністю; картки позначаються Viewed, коли ви їх відкриваєте; приватні нотатки, мультифільтри, пошук, підсвітка нових і кнопка
  копіювання листа
...
приглушеною позначкою «· closed») і не відкриваються назад кліком. Налаштування: `CLOSED_MAX`
