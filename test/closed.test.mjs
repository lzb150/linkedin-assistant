...
test("selectCandidates: dou/djinni only, new/viewed only, re-checked at most every N days, oldest check first, capped", () => {
  const packages = [
    ...
    { url: "https://ua.jooble.org/x/5", source: "jooble" },     // unsupported source
  ...
  assert.deepEqual(all.map((c) => c.url), ["https://jobs.dou.ua/v/1/", "https://jobs.dou.ua/v/7/", "https://djinni.co/jobs/2/"]);
